                ...
                <div class="container">
                  ...
                  <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">iPlus</a>
                      ...
                      <div class="container">
                      <br> <br> <br>
                      <h3>Daftar Referensi Tanaman</h3>
                        <div class="row">
                          <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                  <h2>Tabel Tanaman Kuartal 1 (Januari - April)</h2>
                                </div>
                                <div class="col-md">
                                    <?php foreach ($Tanaman as $key => $data): ?>
                                          <div class="col-md-3" style="float:left; padding-bottom:4rem">
                                            <div class="card h-100">
                                              ...
                                              <!--  <p class="card-text">Prakiraan harga Rp={{$data->Harga*$data->inflasi1+$data->Harga}}</p> -->
                                              <?php
                                                $angka = ($data->Harga*$data->inflasi1);
                                                $hargaa = ($data->Harga+$angka);
                                                $angkaform = number_format($hargaa);
                                                echo ('Prakiraan Harga'),(' '), ('Rp'),('.'),(' '),$angkaform;
                                                ?>
                                                <p class="card-text">Jangka Waktu Tanam = {{$data->jangka}} hari</p>
                                                <a href="{{url('/pilih/')}}/{{$data->id_tanam}}"><button type="submit" id="btn_{{$key+1}}" <?= ($data->pilihan < 1) ? 'disabled' : '' ?> class="btn btn-primary"> PILIH </button></a>
                                              </div>
                                            </div>
                                          </div>
                                        <?php endforeach; ?>
