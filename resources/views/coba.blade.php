...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <tr>
    <td align="center">{{ $value->id_tanam}}</td>
    <td align="center">{{ $value->nama}}</td>
    <td align="center">{{ $value->curah}}</td>
    <td align="center">{{ $value->kelembapan}}</td>
    <td align="center">{{ $value->suhu}}</td>
    <td><img class="card-img-top" src="data:image/jpg;base64,{{ chunk_split(base64_encode($value->Gambar)) }}" ></td>
    <td align="center">{{ $value->Harga}}</td>
    <td align="center">{{ $value->jangka}}</td>
    <td align="center">{{ $value->inflasi1}}</td>
    <td align="center">{{ $value->inflasi2}}</td>
    <td align="center">{{ $value->inflasi3}}</td>
    <td>
      <a href="tanaman/edit/{{$value->id_tanam}}">Edit</a>
      |
      <a href="tanaman/hapus/{{$value->id_tanam}}">Hapus</a>
    </td>
    </tr>
    <?php endforeach; ?>
    </table>
