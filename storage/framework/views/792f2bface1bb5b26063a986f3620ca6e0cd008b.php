                                          ...
                                          <div class="col-md-3" style="float:left; padding-bottom:4rem">
                                            <div class="card h-100">
                                              ...
                                              <?php
                                                ...
                                                <a href="<?php echo e(url('/pilih/')); ?>/<?php echo e($data->id_tanam); ?>"><button type="submit" id="btn_<?php echo e($key+1); ?>" <?= ($data->pilihan < 1) ? 'disabled' : '' ?> class="btn btn-primary"> PILIH </button></a>
                                              </div>
                                            </div>
                                          </div>
                                        <?php endforeach; ?>
...
<?php /**PATH /home/172410102011/nat/resources/views/kuartal1.blade.php ENDPATH**/ ?>