...
<div class="wrapper">
  ...
  <div class="content-wrapper">
          ...
          <h1 align=center href="tambah">Data User Petani </h1>
          <br/>
          <br/>
          <div align="center">
          <a align=right href="petani/tambah"> + Tambah Data Baru</a>
          ...
          <?php foreach ($Petani as $key => $value): ?>
          <tr>
          <td align="center"><?php echo e($value->id); ?></td>
          <td align="center"><?php echo e($value->name); ?></td>
          <td align="center"><?php echo e($value->email); ?></td>
          <td align="center"><?php echo e($value->password); ?></td>
          <td>
            <a href="petani/edit/<?php echo e($value->id); ?>">Edit</a>
            |
            <a href="petani/hapus/<?php echo e($value->id); ?>">Hapus</a>
          </td>
          </tr>
          <?php endforeach; ?>
          </table>
...
<?php /**PATH /home/172410102011/nat/resources/views/user.blade.php ENDPATH**/ ?>