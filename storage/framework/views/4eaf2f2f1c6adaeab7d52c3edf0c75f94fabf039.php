...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <h1 align=center href="tambah">Data Cuaca </h1>
    <br/>
    <br/>
    <div align="center">
    <a align=right href="cuaca/tambah"> + Tambah Data Baru</a>
    <table width="1200" border="2" bgcolor="#DCDCDC">
    <tr>
    <th width="100px">Kuartal</th>
    <th width="150px">Curah Hujan</th>
    <th width="150px">Kelembapan</th>
    <th width="150px">Suhu</th>
    <th width="100px">Opsi</th>
    </tr>
    <?php foreach ($Cuaca as $key => $value): ?>
    <tr>
    <td align="center"><?php echo e($value->kuartal); ?></td>
    <td align="center"><?php echo e($value->curah_hujan); ?></td>
    <td align="center"><?php echo e($value->kelembapan); ?></td>
    <td align="center"><?php echo e($value->suhu); ?></td>
    <td>
      <a href="cuaca/edit/<?php echo e($value->id); ?>">Edit</a>
      |
      <a href="cuaca/hapus/<?php echo e($value->id); ?>">Hapus</a>
    </td>
    </tr>
    <?php endforeach; ?>
    </table>
...
<?php /**PATH /home/172410102011/nat/resources/views/cuaca.blade.php ENDPATH**/ ?>