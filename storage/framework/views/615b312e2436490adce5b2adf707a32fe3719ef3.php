      ...
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">iPlus</a>
            ...
            <div class="container">
            <br> <br> <br>
            <h3>Daftar Rekomendasi Tanaman</h3>
              <div class="row">
                <div class="col-md-12">
                  <div class="box">
                      <div class="box-header with-border">
                        <h2>Tabel Tanaman Kuartal 4 (Oktober - Desember)</h2>
                      </div>
                      <div class="col-md">
                                ...
                                <div class="col-md-3" style="float:left; padding-bottom:4rem">
                                  <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                      ...
                                      <p class="card-text">Prakiraan harga Rp= <?php echo e($data->Harga); ?></p>
                                      <button type="submit" id="btn_<?php echo e($key+1); ?>" class="btn btn-primary" onclick="myFunction(<?php echo e($key+1); ?>)">PILIH</button>
                                    </div>
                                  </div>
                                </div>
                              <?php endforeach; ?>
            ...
            <script>
              ...
              {
              document.getElementById("btn_"+angka).disabled = true;
              }
            </script>
          </div>
        </div>
...
<?php /**PATH /home/172410102011/nat/resources/views/kuartal4.blade.php ENDPATH**/ ?>