      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="admin/tanaman"><i class="fa fa-circle-o"></i> Data Tanaman </a></li>
            <li><a href="admin/cuaca"><i class="fa fa-circle-o"></i> Data Cuaca </a></li>
            <li><a href="admin/petani"><i class="fa fa-circle-o"></i> Data User Petani </a></li>
            <li><a href="admin/pemilik"><i class="fa fa-circle-o"></i> Data User Pemilik/Bos </a></li>
          </ul>
        </li>
    </section>
    <!-- /.sidebar -->
...
<?php /**PATH /home/172410102011/nat/resources/views/bos.blade.php ENDPATH**/ ?>