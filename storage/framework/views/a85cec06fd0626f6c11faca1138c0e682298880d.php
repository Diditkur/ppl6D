    ...
    <nav class="navbar navbar-expand-lg navbar-primary bg-dark fixed-top" id="mainNav">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="home">iPlus</a>
            ...
            <a class="nav-link" href="welcome">Home <span class="sr-only">(current)</span></a> <link rel="stylesheet">
              </li>
              <li class="nav-item">
              <a class="nav-link" href="akun">Logout</a> <link rel="stylesheet">
              </li>
            </ul>
      </nav>
            <div class="container">
...
<?php /**PATH /home/172410102011/nat/resources/views/template.blade.php ENDPATH**/ ?>